...
if __name__ == "__main__":
    ...
    default_output = "./output/course_reading_lists_with_vietnamese_name.xlsx"
    ...
    export_to_excel(all_reading_lists, "output")

    # mapping vietnamese name
    mapping_excel(mapping_excel, default_output)
